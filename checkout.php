                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <div class="pull-right"><span id="total"></span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-pull-6 col-sm-pull-6">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="col-md-12"><strong>Shipping:</strong></div>
                                <div class="col-md-12">
				...
				$.each( items, function( key, value ) {
				  ...
				  var html = '<div class="form-group">'+
                                '<div class="col-sm-6 col-xs-6">'+
                                    ...
                                    '<div class="col-xs-12"><small>Quantity: <span>'+qty+'</span></small></div>'+
                                '</div>'+
                                '<div class="col-sm-3 col-xs-3 text-right">'+
                                    '<h6><span>Rp </span>'+amount.formatMoney(0, ',', '.')+'</h6>'+
                                '</div>'+
                                '<div class="col-sm-3 col-xs-3 text-right">'+
                                    '<h6><span>Rp </span>'+Subtotal.formatMoney(0, ',', '.')+'</h6>'+
                                '</div>'+
                            '</div>'+
                            '<div class="form-group"><hr /></div>';
